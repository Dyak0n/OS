...
### <p> 9. Використання готових Docker Images. Ознайомитись із готовими Docker Images які знаходяться на Docker Hub. Використати образ wordpress та розвернути сайт із безкоштовною темою. </p>
...
#### <p align="center"> Малюнок 9. wordpress docker image </p>
...
#### <p align="center"> Малюнок 9.1. Розгортання wordpress image </p>
...
#### <p align="center"> Малюнок 9.2. Конфігураційний файл docker-compose.yml </p>
...
#### <p align="center"> Малюнок 9.3. Відтворення команди docker-compose up -d </p>
...
#### <p align="center"> Малюнок 9.4. ВСкриншот розгорнутого сайту з зміненою темою
 </p>

----

### <p> 10. Використання Docker Compose. Описати теоретично що таке Docker Compose, чому саме розширення .yml а також навести переваги та недоліки його використання. Навести приклад створення та збирання образа за допомогою Docker Compose. </p>
...
### <p> 11. Створення HTML сторінки та занесення її в Docker Image. </p>
...
#### <p align="center"> Малюнок 11.1. Вміст HTML сторінки </p>
...
#### <p align="center"> Малюнок 11.2. Вміст Dockerfile </p>
...
#### <p align="center"> Малюнок 11.3. Виконання команди docker build -t index . </p>
...
#### <p align="center"> Малюнок 11.4. Виконання команди docker run -d -p 8088:80 index </p>
...
#### <p align="center"> Малюнок 11.5. Скриншот працездатності сайту </p>
...
#### <p align="center"> Малюнок 11.6. Скриншот репозиторію </p>

----

### <p> 12. Скачати Docker Image когось із групи і розвернути в себе контейнер з HTML сторінкою на порті 8086 ззовні. </p>
...
#### <p align="center"> Малюнок 12.1. Скриншот працездатності сайту </p>
